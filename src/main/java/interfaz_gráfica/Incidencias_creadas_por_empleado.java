...
public class Incidencias_creadas_por_empleado extends javax.swing.JDialog {
     ...
     */
    public Incidencias_creadas_por_empleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void actionPerformed(ActionEvent e) {
                if (cb_empleados.getSelectedItem() != null) {
                    ...
                    if (!lista_incidencias.isEmpty()) {
                        ...
                        JOptionPane.showMessageDialog(Incidencias_creadas_por_empleado.this, "No existe incidencias originadas por este usuario", "Error", JOptionPane.WARNING_MESSAGE);
                        modelo.setRowCount(0);
                        return;
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Incidencias_creadas_por_empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Incidencias_creadas_por_empleado dialog = new Incidencias_creadas_por_empleado(new javax.swing.JFrame(), true);
